...
class CompanyType extends AbstractType
{
    ...
    {
        $builder
            ->add('type', TextType::class, array('label' => 'Type', 'attr' =>[
                'placeholder' => 'Type de votre entreprise','class' => 'form-control']))
            ->add('name', TextType::class, array('label' => 'Nom', 'attr' =>[
                'placeholder' => 'Votre entreprise', 'class' => 'form-control']))
            ->add('adress', TextType::class, array('label' => 'Adresse', 'attr' =>[
                'placeholder' => '1 rue de votre entreprise', 'class' => 'form-control']))
            ->add('postalCode', TextType::class, array('label' => 'Code Postal', 'attr' =>[
