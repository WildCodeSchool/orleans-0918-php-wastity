...
final class Version20181204100334 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE schedule CHANGE opening_am opening_am TIME NOT NULL, CHANGE closing_am closing_am TIME NOT NULL, CHANGE opening_pm opening_pm TIME NOT NULL, CHANGE closing_pm closing_pm TIME NOT NULL');
    }
