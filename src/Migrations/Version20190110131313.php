...
final class Version20190110131313 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, association_id INT DEFAULT NULL, company_id INT NOT NULL, foodhero_id INT DEFAULT NULL, status_id INT NOT NULL, picture VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, weight DOUBLE PRECISION NOT NULL, start DATETIME NOT NULL, end DATETIME NOT NULL, description LONGTEXT NOT NULL, complementary LONGTEXT DEFAULT NULL, active TINYINT(1) DEFAULT NULL, INDEX IDX_29D6873EEFB9C8A5 (association_id), INDEX IDX_29D6873E979B1AD6 (company_id), INDEX IDX_29D6873EBD4686ED (foodhero_id), INDEX IDX_29D6873E6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
